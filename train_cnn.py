...
if modelNo == "unet":
    ...
    from model_zoo.pidi_cnn import *
...
for epoch in range(epoches):
    ...
    print('Epoch: {}. Train Loss: {}. Val Loss: {}. Train IoU: {}. Val IoU: {}. Time: {}. LR: {}'
          .format(epoch + 1, torch.mean(torch.stack(train_losses)), torch.mean(torch.stack(val_losses)),
                  ...
                  learningRate))
    torch.save(model.state_dict(),'./pidi_model/9.28_cnn/pidi_epoch{}_val{}.pth'.format(epoch,torch.mean(torch.stack(val_accuracies))))
    print('/n')
